...
var infotext = "Klicke auf eine Publikation für mehr Infos.";
...
//	d3.slider().min(minyear).max(maxyear);  
  d3.select("#slider").on("input", function() {
  	...
  	var test = this.value;
//  	var test2 = this.values[0];
  		console.log("eingabe beim schieberegler: " + test);
  		d3.select('#slidertextmin').text(this.value);
//	 	d3.select('#slidertextmax').text(values[ 1 ]);
...
//			$("#vonbis").val(ui.values[0] + " bis " + ui.values[1]);
//		}
	});
//		$("#vonbis").val($("slider2").slider("values", 0)
